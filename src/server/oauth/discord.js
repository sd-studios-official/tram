...
const redirect = encodeURIComponent('http://localhost:3001/api/discord/callback')
...
router.get('/callback', catchAsync(async (req, res) => {
  ...
  params.append('redirect_uri', 'http://localhost:3001/api/discord/callback')
...
router.get('/refresh', catchAsync(async (req, res) => {
  ...
  if (!cookie || cookie === undefined) {
    return res.redirect('http://localhost:3001/api/discord/login')
  }
  ...
  res.redirect('http://localhost:3001/api/discord/info')
}))
